...
<body>
	...
	<div class="text-vertical-center">
		<h1>An-Vel Trading's Inventory Management</h1>


		<br> <a href="#about" class="btn btn-dark btn-lg">Services</a>
	</div>
	</header>
				...
				<div class="row">
					<div class="col-md-3 col-sm-6">
						<div class="service-item">
							<span class="fa-stack fa-4x"> <img src="img/icon1.png"
					...
					<div class="col-md-3 col-sm-6">
						<div class="service-item">
							...
							<p>Update items in your inventory</p>
					...
					<div class="col-md-3 col-sm-6">
						<div class="service-item">
							...
							<p>Click Delete button to delete items.</p>
							<a href="list.html" class="btn btn-light">Delete</a>
						</div>
					</div>
				</div>
				<!-- /.row (nested) -->
